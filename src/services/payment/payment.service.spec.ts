...
describe('PaymentService', () => {
  ...
  describe('getPaymentByOrderId', () => {
    ...
    it('throws NotFoundException when no payment exists for that order', async () => {
      ...
      await expect(service.getPaymentByOrderId(99)).rejects.toThrow(
        NotFoundException,
      );
    });
  });
  ...
  describe('confirmPayment', () => {
    it('throws NotFoundException when payment does not exist', async () => {
      ...
      await expect(service.confirmPayment({ paymentId: 1 })).rejects.toThrow(
        NotFoundException,
      );
    });

    it('throws BadRequestException when payment is already PAID', async () => {
      prisma.payment_findFirst.mockResolvedValue(
  ...
  describe('cancelPayment', () => {
    it('throws NotFoundException when payment does not exist', async () => {
      ...
      await expect(service.cancelPayment(99)).rejects.toThrow(
        NotFoundException,
      );
    });
    ...
    it('throws BadRequestException when payment is already PAID', async () => {
      ...
      await expect(service.cancelPayment(1)).rejects.toThrow(
        BadRequestException,
      );
    });
